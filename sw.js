...
self.addEventListener('fetch', (e) => {
  ...
  // App shell: network-first for HTML/JS (always get latest if online), cache fallback for offline.
  // This avoids serving stale buggy code after deploys.
  if (url.origin === self.location.origin) {
    const isShellDoc = req.mode === 'navigate' || url.pathname.endsWith('.html') || url.pathname.endsWith('.js') || url.pathname.endsWith('/');
    if (isShellDoc) {
